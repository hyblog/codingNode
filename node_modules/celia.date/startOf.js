...
function startOf (date, unit) {
  ...
  switch (unit) {
    case _normalizeUnit.YEAR:
      time = _startOf.startOfDate(date, null, 0, 1);
      break;
    case _normalizeUnit.MONTH:
      time = _startOf.startOfDate(date, null, null, 1);
      break;
    case _normalizeUnit.DATE:
    case _normalizeUnit.DAY:
      time = _startOf.startOfDate(date);
      break;
    case _normalizeUnit.HOUR:
      time = _startOf.startOfTime(date, _dateConsts.MS_OF_HOUR);
      break;
    case _normalizeUnit.MINUTE:
      time = _startOf.startOfTime(date, _dateConsts.MS_OF_MINUTE);
      break;
    case _normalizeUnit.SECOND:
      time = _startOf.startOfTime(date, _dateConsts.MS_OF_SECOND);
      break;
  }
